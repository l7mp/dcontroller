...
| Field           | Type                   | Required | Description                                                                                                                                                                                                                                           |
|-----------------|------------------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `apiGroup`      | `string`               | No       | The API group of the resource. **Default**: An internal view. For the core Kubernetes group, use `""`. For virtual sources, use `"source.dcontroller.io"`. Example: `apps`.                                                                          |
